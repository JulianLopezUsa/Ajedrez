...
public class Verificaciones {
    ...
    public int cacheX, cacheY, cont =0;
    public String tipo = "";
    public Tablero tablero;
    public ArrayList<String> posiblesMovimeintos = new ArrayList<>();
    ...
    public void VerificarPosiblesMovimientos(Fichas f, int i, int j, Tablero tablero, AjedrezServlet ev, String tipo) {
        ...
        if (f != null) {
            ...
            if (banderaJaque) {
                ...
                posiblesMovimeintos = f.getLista();
    ...
    public void verificarMovimientoAmarillo(int i, int j, AjedrezServlet ev, Tablero tablero, String tipo) {
            ...
            if (fichaSeleccionada instanceof Peon) {
                if (((Peon) fichaSeleccionada).alcanzoExtremoTablero(i, j)) {
                    ...
                    if (tipo.equals("cliente")) {
                        if(cont==1){
                            ev.coronacionFichaVista2();
                            cont = 0;
                        }
                        if (tablero.getTurno() != 0) {
                            cont = 1;
                            nn = ev.coronacionFichaVista(tablero.getTurno(),
    ...
    public boolean cambioVistaEnroque(Fichas fichaSeleccionada, int i, int j, Tablero tablero, AjedrezServlet ev,
            String tipo) {
