...
public class EventoServidor implements ActionListener, Runnable {
    ...
    public EventoServidor(TableroServidor vistaTablero, Tablero tablero, Servidor servidor) {
    ...
    public boolean cambioVistaEnroque(Fichas fichaSeleccionada, int i, int j, TableroServidor vistaTablero) {
